	...
	public static function getImages(&$params){
		...
		while($i < 22) :
			...
			if( ($params->get('image'.$i)) && ($params->get('image'.$i.'cap')) && ($params->get('image'.$i.'customlink') != '') ) {
					...
					$listitem = "<li><a target='".$params->get('target')."' href='".$params->get('image'.$i.'customlink')."'><img title='' alt='".$params->get('image'.$i.'alt')."' src='".JURI::root().$params->get('image'.$i)."' /><div class = 'bgcolor'><span class='' >".$params->get('image'.$i.'cap')."</span></div></a></li>";
					// $listitem = "<li><a target='".$params->get('target')."' href='".$params->get('image'.$i.'customlink')."'><img title='' alt='".$params->get('image'.$i.'alt')."' src='".JURI::root().$params->get('image'.$i)."' /><div class = 'bgcolor'><span class='flex-caption' style='color:".$params->get('color_caption')."'>".$params->get('image'.$i.'cap')."</span></div></a></li>";
			...
			// if image + caption + no link
					...
					// $listitem = "<li><img title='' alt='".$params->get('image'.$i.'alt')."' src='".JURI::root().$params->get('image'.$i)."' /><div class = 'bgcolor'><span class='flex-caption' style='color:".$params->get('color_caption')."'>".$params->get('image'.$i.'cap')."</span></div></li>";
				$listitem = "<li><img title='' alt='".$params->get('image'.$i.'alt')."' src='".JURI::root().$params->get('image'.$i)."' /><div class = 'bgcolor'><span class=''>".$params->get('image'.$i.'cap')."</span></div></li>";
					array_push($imgsAndCaps, $listitem);
