...
// Include config file and twitter PHP Library by Abraham Williams (abraham@abrah.am)
                    ...
                    $profile = $session->get('profileimage');

    if (!empty($_GET['flu_name'])){
        $flu_name = $_GET['flu_name'];
    } else {
        $flu_name = '';
    }
?>
...
<!-- load map resources -->
<script async defer src="https://maps.googleapis.com/maps/api/js?v=3&key=AIzaSyBJFnq1UPeiHsuwgY6cgnN2-pi3Yz86zr0&libraries=places,geometry"></script>
...
<div class="fm-body fm-body-hide">
    ...
    <div class="col-md-12">
        ...
        <div class="nfm-landing" >
            <div class="col-md-5 pad-0">
                <label class="blue-text header-title-small">THE NATIONAL FLU MONITOR</label>
            ...
            <div class="col-md-6 flu-count">
                <div class="col-md-12">
                    <div class="col-md-4 col-sm-4 col-xs-4 pad-0">
                        <div class="nfr_cnt header-title-small red-text-futura nfr_cnt"></div>
                        <div class="p3 p_upper">National Flu Reports</div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-3 pad-0">
                        <div class="fr_cnt header-title-small red-text-futura fr_cnt"></div>
                        <div class="p3 p_upper">Flu Reports</div>
                    </div>
                    <div class="col-md-5 col-sm-5 col-xs-5 pad-0">
                        <div class="l_cnt header-title-small red-text-futura flu-location p_upper default_location"></div>
                        <div class="p3 p_upper ">Location</div>
                    </div>
                </div>
                <div class="col-md-12 pad-0">
                        <div class="pad-0 flu-monitor-btn-home">
                            <div class="col-md-12 flu-btn-inside pad-0">
        ...
        <div class="nfm-flumap" style="display:none;">
            <div class="col-md-3 pad-0">
                <div class="red-text header-title-small">FLU MAP</div>
                <div class="blue-text header-title default_location flu-location"></div>
            </div>
            <div class="col-md-4 flu-count">
                <div class="col-md-4 col-sm-4 col-xs-4 pad-0">
                    <div class="fr_cnt header-title-small red-text-futura"></div>
                    <div class="p3 p_upper">flu reports in this area</div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4 pad-0">
                    <div class=" nfr_cnt header-title-small red-text-futura"></div>
                    <div class="p3 p_upper">national flu reports</div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4 pad-0">
                    <div class="l_cnt header-title-small red-text-futura nfm_drugStores"></div>
                    <div class="p3 p_upper ">Bioflu stores near you</div>
                </div>
            </div>

            <div class="col-md-5 pad-0">
                        <div class="pad-0 flu-monitor-btn">
                            <div class="col-md-12 flu-btn-inside pad-0">
                                <div class="col-md-3 col-xs-3 col-sm-3 pad-0">
                                    <button data-name="flu" class="flu flu-btn p_upper ">FLU MAP</button>
                                </div>
...
<!--             <div class="col-md-4 flubuzz pad-0">
        ...
        <div class="nfm-drugstores" style="display:none;">
            <div class="col-md-5 pad-0">
                <div class="blue-text header-title-small p_upper col-md-12 pad-0">Find drugstores</div>
                <div class="blue-text header-title p_upper col-md-12 pad-0">near you</div>
                <div class="red-text header-title p_upper flu-location col-md-12 pad-0 default_location"></div>
            </div>
            <div class="col-md-2"></div>
            <div class="col-md-5 pad-0">
                        <div class="pad-0 flu-monitor-btn">
        ...
        <div class="nfm-hospital" style="display:none;">
            <div class="col-md-5 pad-0">
                <div class="blue-text header-title-small p_upper col-md-12 pad-0">Hospitals / Clinic</div>
                <div class="blue-text header-title p_upper col-md-12 pad-0">near you</div>
                <div class="red-text header-title p_upper flu-location col-md-12 pad-0 default_location"></div>
            </div>
            <div class="col-md-2"></div>
...
<div class="col-md-12 parent-container pad-0" style="height:500px;padding-bottom: 3% !important;">   
    ...
    <div class="pad-0 container flu-monitor-mobile" style="display:none;">
        <div class="col-md-6 flu-btn-inside">
            <div class="col-md-3 col-xs-3 col-sm-3 pad-0" style="    padding-bottom: 10px !important;">
                <button data-name="flu" class="flu flu-btn p_upper ">FLU MAP</button>
            </div>
            <div class="col-md-4 col-xs-4 col-sm-4 pad-0">
                <button data-name="drugstores" class="drugstores flu-btn p_upper ">DRUGSTORES</button>
    ...
    <div class="child-containers col-md-12 col-xs-12 col-sm-12 panel map-container pad-0" style="height:100%;">
        <input id="pac-input" class="search-controls" type="text" placeholder="Search by city">
...
<div class="col-md-12 fmn-about pad-45" id="fmn-about">

    <div class="col-md-12  pad-0">
        <div class="col-md-12"><label class="blue-text header-title-small nfm-title"></label></div>
...
<!-- <div class="pad-0 flu-monitor-btn container">
    <div class="col-md-7 flu-btn-inside">
        <div class="col-md-3 col-xs-3 col-sm-3 pad-0">
            <button data-name="flu" class="flu flu-btn p_upper ">FLU MAP</button>
        </div>
        <div class="col-md-4 col-xs-4 col-sm-4 pad-0">
...
$('.nfm-header-mobile').show();
$('.plus-sign-mobile').show();

}


var flu_name = "<?php echo $flu_name; ?>";
if(flu_name == ''){
    
} else {
        $('.fm-body-hide').removeClass('fm-body');
        $('.fmn-about').hide();
        $('.drugstores').addClass('flu-btn-active');
        $('.list-container').html('');
        $('.pagination').html('');
        var limit = '10';
        var offset = '1';
...
function countTags(location)
{
    ...
    $.ajax({
        ...
        if(location != ""){
            ...
            $('.default_location').html(callback.location);
        }
...
$('.nfm-header').show();
$('.nfm-header-mob').show();
$('.nfm-header-plus').show();
$('.logo-text').addClass("logo-text-mob");
$('.logo-title').addClass("logo-title-mob");
$('.violator img').addClass("violator-mob");
$(document).on('click', '.flu-btn', function(){  
    ...
    if(flu_name == 'drugstores'){
       ...
       $('.'+flu_name).addClass('flu-btn-active');
        $('.list-container').html('');
        $('.pagination').html('');
        var limit = '10';
        var offset = '1';
       ...
       flu_name = 'drugstores';
        ...
        $('.nfm-drugstores').show();
        if (screensize < 800){
            $('.flu-monitor-btn').hide();
            $('.flu-monitor-mobile').show();
            $('.'+flu_name).addClass('flu-btn-active');
        }
       ...
       /* Hospital */
        ...
        if (screensize < 800){
            $('.flu-monitor-btn').show();
            $('.flu-monitor-mobile').hide();
            $('.'+flu_name).addClass('flu-btn-active');
        }
