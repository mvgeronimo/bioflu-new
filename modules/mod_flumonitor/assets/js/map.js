...
var objectMap = { //map object
    ...
    centerLat: 12.879721,  //latitude property to set for initial center point for the map object
    centerLng: 121.77401699999996, //longitude property to set for initial center point for the map object
    ...
    deleteAllMarkers:function()
    {
            ...
            // while(objectMap.markers.markersArray.length) { objectMap.markers.pop().setMap(null); }
            // while(objectMap.storeMarks.markersArray.length) { objectMap.storeMarks.pop().setMap(null); }
            // while(objectMap.hosMarks.markersArray.length) { objectMap.hosMarks.pop().setMap(null); }
            ...
            objectMap.hosMarks = [];
            objectMap.markers = [];
            // objectMap.storeMarks.setMapOnAll(null);
            // objectMap.hosMarks.setMapOnAll(null);
    ...
    areaMarker:function(tData,map)
    {
        ...
        for(var key in tData ){
            ...
            for(var b in a)
            {
                ...
                var myTitle = "There are "+size+" person/people who has multiple symptoms";
                var areaText = '<div class="info-container" style=" padding:5px; color:white;  zindex:999;font-weight:bold;"><div class="area-text">“4 Low number of flu cases reported in this area. However, the flu virus can spread fast especially during rainy season. So be sure you constantly monitor the spread of flu using this Flu Monitor System.  You can also follow us on Twitter @BiofluOfficial and on Facebook (BiofluOfficial) to get updates.” </div></div>';
                var icon2 = {
...
function drawAreaMarkers(size,dbPoints,tkey)
{
    ...
    var few_symp_img ='./images/bioflu/pins/areamarker_few_small.png';
    var myTitle = "There are "+size+" person/people who has multiple symptoms";
    var areaText = '<div class="info-container" style=" padding:5px; color:white;  zindex:999;font-weight:bold;"><div class="area-text">“1 Low number of flu cases reported in this area. However, the flu virus can spread fast especially during rainy season. So be sure you constantly monitor the spread of flu using this Flu Monitor System.  You can also follow us on Twitter @BiofluOfficial and on Facebook (BiofluOfficial) to get updates.” </div></div>';
    var icon2 = {
        url: few_symp_img, // url
        scaledSize: new google.maps.Size(30, 30), // scaled size
        origin: new google.maps.Point(0,0), // origin
...
{   
    ...
    var markerCluster = new MarkerClusterer(map, markers,{
        ...
        markerCluster.addListener('mouseover',function(c){
            ...
            var areaText = '<div class="info-container" style=" padding:5px; color:white;  zindex:999;font-weight:bold;"><div class="area-text">“2 Low number of flu cases reported in this area. However, the flu virus can spread fast especially during rainy season. So be sure you constantly monitor the spread of flu using this Flu Monitor System.  You can also follow us on Twitter @BiofluOfficial and on Facebook (BiofluOfficial) to get updates.” </div></div>';
            var size = c.getSize();
        ...
        markerCluster.addListener('click',function(c){
            var zoom = objectMap.map.getZoom();
            var areaText = '<div class="info-container" style=" padding:5px; color:white;  zindex:999;font-weight:bold;"><div class="area-text">“ 3Low number of flu cases reported in this area. However, the flu virus can spread fast especially during rainy season. So be sure you constantly monitor the spread of flu using this Flu Monitor System.  You can also follow us on Twitter @BiofluOfficial and on Facebook (BiofluOfficial) to get updates.” </div></div>';
            var size = c.getSize();
            var center = c.getCenter();
            if(size >= 6)
            {
