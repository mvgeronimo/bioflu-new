...
$(document).ready(function() {
  ...
  function last(){
    ...
    $.ajax({
        ...
        data:{limit:limit, offset:offset, table:table, order_by:order_by,cat_type:cat_type},
      }).done( function(data){
          ...
          $.each(obj, function(index, row){ 
            if(row.state==1){
              ...
              htm+="<td><d style='color:#3071a9'>"+row.article_title+"</d></td>";
              htm+="<td class='pag2flu-img'><img class='img-responsive ' src='../"+row.image+"' /></td>";
              htm+="<td>"+state+"</td>";
  ...
  function get_pagination(page_num,limit){
    ...
    $.ajax({
        ...
        data:{limit:limit, table:table, order_by: order_by,cat_type:cat_type},
      }).done( function(data){
          var htm = '';
