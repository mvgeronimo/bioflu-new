		...
		<div class="col-md-9 container-content">
			...
			<div class="row">
				...
				<div class="col-md-12 pad-0">
					...
					<div class="col-md-12 title-header"><p> Widgets </p></div>
...
<!-- 					<button class="btn-filemanager btn-min btn btn-default"><span class = "glyphicon glyphicon-picture"></span>Image Manager</button>
			...
			<div class="content-container">
				...
				<?php  require_once dirname(__FILE__) . '/widgets/edit.php'; ?>				
...
$(document).ready(function() {
	...
	$('.article_add').click(function() {
		...
		$(this).hide();
		$('.content-container').load('widgets/add.php');
	...
	$('.article_list').click(function() {
		...
		$('.content-container').load('widgets/list.php');
	});
	...
	$(document).on('click','.edit',function(){
		...
		$('.content-container').load('widgets/edit.php?id='+id);
	});
