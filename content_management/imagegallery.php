		...
		<div class="col-md-9 container-content">
			...
			<div class="row">
				...
				<div class="col-md-12 pad-0">
					...
					<div class="col-md-12 title-header"><p> Image Gallery </p></div>
			...
			<div class="content-container">
				...
				<?php  require_once dirname(__FILE__) . '/imagegallery/list.php'; ?>				
...
$(document).ready(function() {
	...
	$('.img_add').click(function() {
		...
		$('.content-container').load('imagegallery/add.php');
	...
	$('.article_list').click(function() {
		...
		$('.content-container').load('imagegallery/list.php');
	...
	$(document).on('click','.edit',function(){
		...
		$('.content-container').load('imagegallery/edit.php?id='+id);
	});
