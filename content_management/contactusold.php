		...
		<div class="col-md-9 container-content">
			...
			<div class="row">
				...
				<div class="col-md-12 pad-0">
					...
					<div class="col-md-12 title-header"><p> Contact Us </p></div>
			...
			<div class="content-container">
				...
				<?php  require_once dirname(__FILE__) . '/contactus/list.php'; ?>				
...
$(document).ready(function() {
	...
	$('.article_add').click(function() {
		...
		$('.content-container').load('contactus/add.php');
	...
	$('.article_list').click(function() {
		...
		$('.content-container').load('contactus/list.php');
	...
	$(document).on('click','.edit',function(){
		...
		$('.content-container').load('contactus/edit.php?id='+id);
	});
