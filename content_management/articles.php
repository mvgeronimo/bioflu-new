		...
		<div class="col-md-9 container-content">
			...
			<div class="row">
				...
				<div class="col-md-12 pad-0">
					...
					<div class="col-md-12 title-header"><p> Articles </p></div>
				...
				<div class="col-md-6 pad-0 search-container">
					<div class="col-md-2">Search</div><div class="col-md-10 pad-0"><input type = "text" class = "fullwidth search-text"><span class = "glyphicon glyphicon-search search-icon" ></span></div>
				</div>
			...
			<div class="content-container">
				...
				<?php  require_once dirname(__FILE__) . '/article/list.php'; ?>				
...
$(document).ready(function() {
	...
	$('.article_add').click(function() {
		...
		$('.content-container').load('article/add.php');
		// window.location = 'article/add.php';
	...
	$('.article_list').click(function() {
		...
		// $('.content-container').load('article/list.php');
		location.reload();
...
$('.upload').on('click', function() {
    var file_data = $('#select-thumbnail-modal #imgfiles').prop('files')[0];   
    var form_data = new FormData();                  
    form_data.append('file', file_data); 

    if ($('#select-thumbnail-modal #imgfiles').val() == '' ) {
    ...
    $.ajax({
                ...
                success: function(php_script_response){
                	setTimeout(function(){
	                   ...
	                   filemanager();
	                   $('#select-thumbnail-modal #imgfiles').val('');
	                    $('.filename').html('');
	               }, 4000);
