        ...
        data:{limit:limit, offset:offset, table:table, order_by:order_by},
          ...
          $.each(obj, function(index, row){ 
            if(row.state==1){
              ...
              htm+="<td class='pag2flu-img'><img class='img-responsive ' src='../"+row.banner+"' /></td>";
              htm+="<td><d style='color:#3071a9'>"+row.video_title+"</d></td>";
              htm+="<td><d style='color:#3071a9'>"+row.video_desc+"</d></td>";
              htm+="<td>"+state+"</td>";
