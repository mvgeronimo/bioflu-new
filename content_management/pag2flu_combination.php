		...
		<div class="col-md-9 container-content">
			...
			<div class="row">
				...
				<div class="col-md-12 pad-0">
					...
					<div class="col-md-12 title-header"><p> Banner Combinations </p></div>
...
<!-- 					<button class="btn-filemanager btn-min btn btn-default"><span class = "glyphicon glyphicon-picture"></span>Image Manager</button>
				...
				<div class="col-md-6 pad-0 search-container" style="display:none;">
			...
			<div class="content-container">
				...
				<?php  require_once dirname(__FILE__) . '/pag2flu_combination/list.php'; ?>				
...
$(document).ready(function() {
	...
	$('.article_add').click(function() {
		...
		$('.content-container').load('pag2flu_combination/add.php');
