...
<div class="col-md-12 pad-5">
    ...
    <div class = "col-md-10">
      ...
      <div class="col-md-12 pad-0 selected-image">
        ...
        <input class = "imgsrc inputs" style="display:none" value=""/><span class = "er-msg">Image should not be empty *</span></div>
...
<div class="col-md-12 pad-5">
    ...
    <div class = "col-md-10">
      ...
      <div class="col-md-12 pad-0 selected-video">
        ...
        <input class = "vidsrc inputs" style="display:none" value=""/><span class = "er-msg">Video should not be empty *</span></div>
...
if(counter == 0){
  ...
  $.ajax({
          ...
          url: 'dashboard.php?function=save_videogallery',

          data:{video:video, image:image, title:title, status: status, desc:desc, feat:feat},
