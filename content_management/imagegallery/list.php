...
$(document).ready(function() {
  ...
  function last(){
    ...
    $.ajax({
        type: 'Post',
        url: 'dashboard.php?function=get_imagegallery',
        data:{limit:limit, offset:offset},
          ...
          $.each(obj, function(index, row){ 
            if(row.state==1){
              ...
              htm+="<td align='center'><img width= '100%' src='../"+row.image+"'></td>";
              htm+="<td>"+row.title+"</td>";
  ...
  function get_pagination(page_num,limit){
    $.ajax({
        type: 'Post',
        url: 'dashboard.php?function=get_imagegallery_count',
        data:{limit:limit},
      }).done( function(data){
          var htm = '';
      ...
      $('.select').each(function() {                
          if (this.checked==true) {
             ...
             var id = $(this).attr('data-id');
              ...
              $.ajax({
                  type: 'Post',
                  url: 'dashboard.php?function=update_imagegallery_status',
