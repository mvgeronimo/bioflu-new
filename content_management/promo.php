	...
	<div class="row">
		...
		<div class="col-md-9 container-content">
			<div class="col-md-12 pad-0">
					<div class="row">
						<div class="col-md-12 title-header"><p> Flu Monitor - Promo</p></div>
						<div class="col-md-6 btn-navigation">
						</div>
						<!-- <div class="col-md-6 pagination"></div> -->
						<div class="col-md-12 content-container">
							<?php  require_once dirname(__FILE__) . '/flumonitor/assignpromo.php'; ?>
						</div>			
				</div>
			</div>
		</div>
...
$(document).ready(function(){
	...
	// $('.content-container').load('flumonitor/promo.php');
