      ...
      <div class="col-md-12 pad-0">
          ...
          <div class="row">
            ...
            <div class="col-md-6 btn-navigation">
              ...
              <a href = "dashboard.php?function=export_tweets&data_get=api" class="btn-export-excel btn-min btn btn-primary">Export to Excel</a>
...
$(document).ready(function(){
  ...
  $('.content-container').load('flumonitor/report_autogenerated_twitter.php');
