	...
	<div class="row">
		...
		<div class="col-md-9 container-content">
				...
				<div class="col-md-12 pad-0">
					<div class="row">
						<div class="col-md-12 title-header"><p> Stock Videos </p></div>
						<div class="col-md-12 btn-navigation">
						
						<input style = "display:none" id = 'imgfiles' type = "file">
						<button class="btn-upload btn-min btn btn-primary"><span class = "glyphicon glyphicon-plus-sign"></span>Add Video</button> <d class = "filename"></d>
...
function filemanager(){
	 $.ajax({
        type: 'Post',
        url: 'dashboard.php?function=getvideos',
        data:{},
      }).done( function(data){
...
$(document).on('click','.image-file',function(){
	...
	$('.content-video').html('<video width="100%" controls=""><source class="image-file img-file_'+id+'" type="video/mp4" src="'+img+'" data-id="'+id+'" title=""></source></video>');
	$('.next').attr('src',img);
