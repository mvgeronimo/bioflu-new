  ...
  <div class="row">
    ...
    <div class="col-md-9 container-content">
      <div class="col-md-12 pad-0">
          <div class="row">
            <div class="col-md-12 title-header"><p> Flu Monitor - Reports - Twitter</p></div>
            <div class="col-md-6 btn-navigation">
              <a href = "dashboard.php?function=get_manual_reports_export" class="btn-export-excel btn-min btn btn-primary">Export to Excel</a>
            </div>
...
$(document).ready(function(){
  ...
  $('.content-container').load('flumonitor/report_manual_entry.php');
